...
import pw.saber.framework.storage.typeadapter.DiscUtil;
import pw.saber.framework.storage.typeadapter.EnumTypeAdapter;
import pw.saber.framework.storage.typeadapter.LocationTypeAdapter;
...
public class Persist {
    ...
    public File getFile(String name) {
        return new File(SaberFramework.getInstance().getDataFolder(), name + ".json");
    }
    ...
    public <T> T loadOrSaveDefault(T def, Class<T> clazz, File file) {
        if (!file.exists()) {
            SaberFramework.log("Creating default: " + file);
            this.save(def, file);
            return def;
        }
        ...
        if (loaded == null) {
            SaberFramework.log(Level.WARNING, "Using default as I failed to load: " + file);
            ...
            SaberFramework.log(Level.WARNING, "Backing up copy of bad file to: " + backup);
    ...
    public <T> T load(Class<T> clazz, File file) {
        ...
        try {
            ...
            SaberFramework.log(Level.WARNING, ex.getMessage());
        }
